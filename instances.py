...
def get_args():
    ...
    parser.add_argument('--download', type=bool, default=False, help='Whether to download training data ')
...
def getLogger(args):
    ...
    if args.log_file_name is None:
        argument_path = 'experiment_arguments-%s.json' % datetime.datetime.now().strftime("%Y-%m-%d_%H.%M.%S")
    else:
    ...
    if args.log_file_name is None:
        args.log_file_name = 'experiment_log-%s' % (datetime.datetime.now().strftime("%Y-%m-%d_%H.%M.%S"))
