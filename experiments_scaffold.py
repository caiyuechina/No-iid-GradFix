...
from fedAlgo.scaffold import local_train_net_scaffold
from instances import *
from models.init_nets import init_nets
from dataShare.sharePolicy import uncertainShare, maxLossShare, getIdx, ntkShare, el2nShare, \
    maxLossEl2nShare
from utils import *
...
def run(args, pool=None):
    ...
    for round in range(args.comm_round):
        ...
        nets, c_nets, c_global = local_train_net_scaffold(nets, selected, global_model, c_nets, c_global, args,
                                                          net_dataidx_map, shareLog, None, device, desc,
                                                          args.gradFix, iidEnhance, pool)
