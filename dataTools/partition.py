...
from dataTools.loadMethod import load_mnist_data, load_fmnist_data, load_cifar10_data, load_svhn_data, load_celeba_data, \
    load_femnist_data, load_cifar100_data, load_tinyimagenet_data
...
def partition_data(dataset, datadir, logdir, partition, n_parties, beta=0.4):
    ...
    if dataset == 'mnist':
        ...
        mkdirs(os.path.join(datadir, "data/generated/"))
        np.save(os.path.join(datadir, "data/generated/X_train.npy"),X_train)
        np.save(os.path.join(datadir, "data/generated/X_test.npy"),X_test)
        np.save(os.path.join(datadir, "data/generated/y_train.npy"),y_train)
        np.save(os.path.join(datadir, "data/generated/y_test.npy"),y_test)
    ...
    #    np.save("data/generated/y_test.npy",y_test)
        ...
        if dataset == 'covtype':
            ...
            X_train[:, :10] = MinMaxScaler().fit_transform(X_train[:, :10])
        else:
            y_train = (y_train+1)/2
