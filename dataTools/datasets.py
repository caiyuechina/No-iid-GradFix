...
class Generated(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load(os.path.join(root,"data/generated/X_train.npy"))
            self.targets = np.load(os.path.join(root,"data/generated/y_train.npy"))
        else:
            self.data = np.load(os.path.join(root,"data/generated/X_test.npy"))
            self.targets = np.load(os.path.join(root, "data/generated/y_test.npy"))
