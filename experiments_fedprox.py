...
from fedAlgo.fedprox import local_train_net_fedprox
...
def run(args, pool=None):
    ...
    for round in range(args.comm_round):
        ...
        nets = local_train_net_fedprox(nets, selected, global_model, args, net_dataidx_map, shareLog,
                                       None, device, desc, args.gradFix, iidEnhance, pool)
