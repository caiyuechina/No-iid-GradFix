...
from dataTools.datasets import MNIST_truncated, CIFAR10_truncated, CIFAR100_truncated, ImageFolder_custom, SVHN_custom, \
...
def get_dataloader(dataset, datadir, train_bs, test_bs, dataidxs=None, noise_level=0, net_id=None, total=0,
                   download=False, datasetVal=False):
    if dataset in (
    'mnist', 'femnist', 'fmnist', 'cifar10', 'svhn', 'generated', 'covtype', 'a9a', 'rcv1', 'SUSY', 'cifar100',
    'tinyimagenet'):
        if dataset == 'mnist':
        ...
        if dataset == "tinyimagenet":
            ...
            if datasetVal:
                train_ds = dl_obj(datadir, dataidxs=dataidxs, train=True, transform=transform_test, download=download)
